...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerFullScreenEffect : System.IDisposable
    {
        ...
        private void CreateCommandBuffer(Camera camera)
        {
            ...
            WeatherMakerScript.Instance.CommandBufferManagerScript.AddCommandBuffer(weatherMakerCommandBuffer);
            cameras.Add(camera);
        }
        ...
        {
            if (Enabled && Material != null && (needsToBeRecreated || !WeatherMakerScript.Instance.CommandBufferManagerScript.ContainsCommandBuffer(camera, RenderQueue, CommandBufferName)))
            {
